...
public final class Config {
	...
	public static final String LOGTAG = "lutalk";

	public static final String BUG_REPORTS = "bugs@lucont.net";


	public static final String DOMAIN_LOCK = null; //only allow account creation for this domain
	public static final String MAGIC_CREATE_DOMAIN = "lucont.net";
